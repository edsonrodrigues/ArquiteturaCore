using Core.Dao;
using Core.Dao.ConfigurationToken;
using Core.Dao.ConfigurationToken.Business;
using Core.Dao.ConfigurationToken.Implementation;
...
namespace Core.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication
                ...
                ).AddJwtBearer(options =>
                {
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes(tokenConfigurations.Secret))
                    };
                });
            ...
            //Injection Autentication jwt token
